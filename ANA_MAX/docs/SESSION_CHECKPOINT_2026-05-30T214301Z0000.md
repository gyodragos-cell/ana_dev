# Session Checkpoint - 2026-05-30T21:43:01+00:00

## Permission manifest runtime coverage gate

## Summary

Added ana_permission_manifest_coverage.py to compare runtime-registered tools against permission_manifest.json, added a focused test for drift detection, wired the coverage step into lab_quality_gate, and documented it in DOCS_INDEX and ANA_PROFILE_MANIFEST.
...
- Consider exposing permission_manifest_coverage or profile_status in VS Code Activity Bar
...
```text
ana_permission_manifest_coverage PASS runtime=91 manifest=91 missing=0 extra=0; pytest governance/router/coach 15 passed; compileall coverage/gate scripts passed; lab_quality_gate PASS with permission_manifest_coverage included report ANA_MAX/dev_artifacts/reports/lab_quality_gate_20260530_214225.json; ana_governance_check PASS 60/60
```

## Risks

- Coverage imports/registers runtime tools and takes about 10-11 seconds
- acceptable for lab_quality_gate but not a tiny pre-commit check.
