# Session Checkpoint - 2026-06-01T13:54:44+00:00

## Examples checklist covers live behavior reload flow

## Summary

Updated ANA_EXAMPLES_AND_TESTS_CHECKLIST for the current live behavior and reload verification flow: added allow-warn collection mode, Post-Reload Verify evidence, and required tests for live behavior, reload consistency, and post-reload verify.
...
```text
pytest governance/live_behavior/post_reload/reload_consistency: 18 passed; ana_governance_check.py: PASS 116/116 report governance_check_20260601_135409.json; rg confirmed checklist rows
```
