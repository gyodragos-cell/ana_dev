# Session Checkpoint - 2026-06-01T14:11:23+00:00

## Docs index links Error Radar dirty-tree flow

## Summary

Added ERROR_RADAR_FINDING_EXAMPLE to DOCS_INDEX as the direct entry point for the Error Radar large dirty-tree finding and Dirty Tree Report follow-up flow.
...
```text
pytest governance/dirty_tree/patch_advisor: 17 passed; governance: PASS 116/116 report governance_check_20260601_141105.json; rg confirmed DOCS_INDEX link
```
