# Session Checkpoint - 2026-06-01T14:05:44+00:00

## Examples index reflects clean PASS state

## Summary

Updated ANA_EXAMPLES_INDEX so Autonomy, Operator Status, and Lab State entries reflect the current clean PASS evidence while keeping stale live behavior as a documented diagnostic scenario.
...
```text
pytest governance/operator_status/lab_state_summary: 28 passed; governance: PASS 116/116 report governance_check_20260601_140529.json; rg confirmed clean PASS notes in examples index
```
