# Session Checkpoint - 2026-05-31T23:25:32+00:00

## Docs index and master context aligned for live behavior flow

## Summary

Updated DOCS_INDEX, ANA_LAB_MASTER_CONTEXT, and CODEX_LAB_MANAGER_PROMPT for the current reload/live-behavior workflow. Documented strict live behavior exit semantics and collection-only --allow-warn in the master context, and added key reload scripts to the Codex manager prompt.
...
```text
pytest governance check: 4 passed; ana_governance_check.py: PASS 116/116; rg confirmed 2026-06-01 docs dates and live behavior/reload script references
```
