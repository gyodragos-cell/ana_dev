# Session Checkpoint - 2026-05-31T22:44:38+00:00

## Reload docs aligned to current 90-tool behavior WARN

## Summary

Aligned bootstrap, AGENT_MEMORY, Lab State example, Autonomy WARN example, and No-Reload advisory example with current live state: tools=90/tool-surface PASS and only live_behavior WARN 2/3 until MCP restart. Added Nucleus Smoke assertions to no_reload quality gate contract test. Verified 15 focused tests and governance PASS 116/116.
