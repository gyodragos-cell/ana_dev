# Session Checkpoint - 2026-05-31T01:11:29+00:00

## Extension docs aligned for v1.0.44

## Summary

Aligned vscode_extension CHANGELOG, README, and MARKETPLACE notes with lab VSIX v1.0.44 and the new Post-Reload Verify Activity Bar command. README now describes Live Console, Nucleus Smoke, Autonomy Pass, Post-Reload Verify, and 91-tool mother-lab expectation. Marketplace notes now point to 1.0.44 artifacts while preserving explicit no-publish unless Billy asks. Verified extension tests PASS 27/27, node --check PASS, no_reload_quality_gate PASS 6/6 with expected live_reload_marker advisory WARN, governance PASS 105/105.
