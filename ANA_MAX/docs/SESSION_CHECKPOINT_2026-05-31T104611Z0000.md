# Session Checkpoint - 2026-05-31T10:46:11+00:00

## Chrome preferred for local dashboard

## Summary

Set ANA VS Code extension Open Dashboard flow to prefer Chrome at C:\Program Files\Google\Chrome\Application\chrome.exe through anaMax.preferredBrowserPath, with fallback to VS Code openExternal if unavailable.

## Current Goal

Stabilize local dashboard/browser opening around the known-good Chrome executable.

## Next Steps

- After next VSIX install/reload, click ANA MAX: Open Dashboard and confirm Live Console shows preferred_browser method
...
- Active installed VSIX needs package/install/reload before the new Open Dashboard behavior appears in VS Code.
