# Session Checkpoint - 2026-05-22T16:09:34+00:00

## Bug hunt checkpoint - compact observation and offline healthcheck

## Summary

Fixed lab bug-hunt findings: compact workspace_situational_awareness git output, boolean-safe MCP params, offline-safe tool_healthcheck safe scope, registry fallback includes new tools, launcher reports live MCP tool count. Existing MCP server must be restarted after registry changes.
