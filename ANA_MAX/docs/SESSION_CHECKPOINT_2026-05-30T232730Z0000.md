# Session Checkpoint - 2026-05-30T23:27:30+00:00

## Runtime deep router escalation example

## Summary

Added RUNTIME_DEEP_ROUTER_ESCALATION_EXAMPLE documenting how tool_router mode=runtime_deep escalates under-the-hood diagnostics through health/events/static binary map/input probe spec/windows insight before invasive instrumentation. No process attach, input capture, memory read, or Frida execution occurred. Verified: tool_router tests PASS 8/8, governance PASS 87/87, governance pytest PASS 4/4, no-reload quality gate PASS 6/6.
