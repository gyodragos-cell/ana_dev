# Session Checkpoint - 2026-05-31T23:27:55+00:00

## LLM index and lab readme aligned with live behavior flow

## Summary

Updated ANA_LAB_LLM_INDEX and LAB_README so future agents see ana_live_behavior_check.py as a high-signal tool, understand strict WARN exit behavior, and know --allow-warn is collection-only. LAB_README quality gate list now includes governance/permission coverage, identity surface, and trace alignment.
...
```text
pytest governance check: 4 passed; ana_governance_check.py: PASS 116/116; rg confirmed live behavior and quality gate wording
```
