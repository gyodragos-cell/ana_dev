# Session Checkpoint - 2026-05-30T23:59:59+00:00

## Code Graph stale map handling

## Summary

Fixed stale graph handling in graph_context_pack and code_context_pack by comparing graph code_map_updated_at with current Code Map updated_at and rebuilding Graph Map when stale. Added CODE_GRAPH_STALE_MAP_HANDLING_EXAMPLE and focused stale-refresh test. Verified: graph/code context + governance tests PASS 7/7, governance PASS 99/99, Nucleus Smoke PASS 9/9, no-reload quality gate PASS 6/6. Live MCP sees new stale flag after reload/server module refresh.
