# Session Checkpoint - 2026-05-31T20:49:36+00:00

## Live Behavior follow-up wording aligned

## Summary

Aligned ana_live_behavior_check next_action with Reload Readiness, Reload Consistency, Operator Status, Post-Reload Verify, and Autonomy. It now says to restart ANA MCP, then run Live Behavior, Reload Consistency, and Post-Reload Verify.

## Current Goal

Keep every stale-live diagnostic using one precise operator follow-up sequence.
...
```text
live/reload/post/autonomy focused pytest 25 passed; live behavior WARN message aligned; reload consistency aligned PASS; lab_quality_gate PASS; no_reload_quality_gate PASS with expected advisory
```

## Risks

- Live MCP remains stale until restart
- this is correctly visible as WARN/advisory.
