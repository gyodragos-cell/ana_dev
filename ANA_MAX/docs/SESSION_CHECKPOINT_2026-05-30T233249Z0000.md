# Session Checkpoint - 2026-05-30T23:32:49+00:00

## Permission blocked action evidence

## Summary

Added PERMISSION_BLOCKED_ACTION_EXAMPLE documenting that input_api_probe without confirm=True is blocked by the permission manifest and returns auto-guidance instead of executing. Verified: governance PASS 89/89, governance pytest PASS 4/4, input_api_probe + tool_healthcheck tests PASS 7/7, no-reload quality gate PASS 6/6.
