# Session Checkpoint - 2026-05-31T23:21:48+00:00

## Live behavior allow-warn collection mode

## Summary

Added ana_live_behavior_check.py --allow-warn for operator/log collection wrappers. Default behavior remains strict: WARN returns non-zero. Updated reload runbook and AGENT_MEMORY so --allow-warn is not treated as a successful reload.
...
```text
pytest live_behavior: 4 passed; live_behavior --allow-warn: printed WARN and exit 0; strict live_behavior: printed WARN and non-zero as expected; focused gate tests: 12 passed; governance: PASS 116/116; no_reload_quality_gate: PASS 8/8 advisory live_behavior
```
