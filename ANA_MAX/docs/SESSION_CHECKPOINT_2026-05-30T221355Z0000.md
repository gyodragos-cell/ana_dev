# Session Checkpoint - 2026-05-30T22:13:55+00:00

## ANA bug report example pack added

## Summary

Added a generic QA/ANA bug report template and a sanitized ANA Autonomy Pass warning example. Governance check now requires both docs, and examples/tests checklist marks bug report template and profile/rules tests as ready.

## Current Goal

Continue serious-project discipline by adding real examples and keeping governance/no-reload gates green.

## Next Steps

- Next candidate: generate a tool profile report from permission_manifest and ANA_PROFILE_MANIFEST, then mark Tool profile report ready in examples checklist.
...
```text
ana_governance_check PASS 62/62; pytest test_ana_governance_check 4 passed; no_reload_quality_gate PASS 6/6 report ANA_MAX/dev_artifacts/reports/no_reload_quality_gate_20260531_011346.json.
```

## Risks

- Example is sanitized but still references local MCP endpoint and private lab behavior
- keep public sharing reviewed.
