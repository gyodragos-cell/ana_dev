# Session Checkpoint - 2026-05-31T01:18:41+00:00

## Checkpoint preservation fix

## Summary

Updated session_checkpoint_tool.py so CURRENT_SESSION_HANDOFF.md preserves manual notes appended after the standard handoff pointer instead of wiping them on each checkpoint. Focused tests pass locally; live MCP may still need reload before this behavior is active.
