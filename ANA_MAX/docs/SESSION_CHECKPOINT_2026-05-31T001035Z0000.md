# Session Checkpoint - 2026-05-31T00:10:35+00:00

## No-reload live reload advisory

## Summary

Added ana_live_reload_check.py as a no_reload_quality_gate advisory. The gate still returns PASS when required checks pass, while printing ADVISORY live_reload_marker if live MCP has not loaded the new graph_context_pack stale marker. Updated NO_RELOAD_QUALITY_GATE_SUMMARY_EXAMPLE. Verified: compile PASS, live reload checker tests PASS 2/2, governance PASS 100/100, relevant tests PASS 6/6, Nucleus Smoke PASS 9/9, no-reload quality gate PASS 6/6 with advisory WARN.
