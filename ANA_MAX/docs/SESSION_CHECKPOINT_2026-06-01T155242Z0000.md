# Session Checkpoint - 2026-06-01T15:52:42+00:00

## Improve live self-healing diagnostics

## Summary

Error Radar now deduplicates findings, sorts by severity before limit, and exposes compact summary breakdowns. Code Context Pack keeps query precise when include_text=false. Live Behavior now checks precise query alias, Graph preference, Error Radar runtime breakdown, and Error Radar summary; MCP reloaded and operator status is PASS checks=6/6. Verified 62 focused tests, no-reload quality gate PASS 8/8, governance PASS 116/116, post-reload PASS.
