# Session Checkpoint - 2026-05-30T22:18:49+00:00

## ANA tool profile report added

## Summary

Added a tool profile report generator that reads permission_manifest.json and writes JSON plus Markdown summaries of all 91 tools by profile, tier, read-only status, confirmation requirements, inactive tools, and unprofiled tools. Examples checklist now marks Tool Profile Report ready.

## Current Goal

Continue serious-project discipline with generated evidence for tool profiles and policy boundaries.

## Next Steps

- Next candidate: add a sanitized tool profile summary example or use profile report in Activity Bar/dashboard later.
...
```text
ana_tool_profile_report generated report: 91 tools, core 45, windows 19, security_lab 11, private_lab 21, public_safe 5, linux 1, inactive 0, unprofiled 0. pytest tool profile/governance 6 passed; governance PASS 63/63; no_reload_quality_gate PASS 6/6.
```

## Risks

- Tool profile report is generated from current manifest
- if runtime tool registration changes, run permission manifest coverage and regenerate report.
