# Session Checkpoint - 2026-05-31T00:30:26+00:00

## Error Radar dirty tree breakdown

## Summary

Improved error_radar large_dirty_tree findings with details for total/tracked/untracked/docs/examples/tests/runtime/checkpoints/sample_paths and next_step. Added focused test for dirty tree breakdown. Verified: error_radar tests PASS 4/4, advisory/live reload/governance tests PASS 8/8, governance PASS 100/100, Nucleus Smoke PASS 9/9, no-reload quality gate PASS 6/6 with live_reload_marker advisory WARN. Live MCP will expose new error_radar details after reload.
