# Session Checkpoint - 2026-05-31T23:24:08+00:00

## Reload readiness example aligned with allow-warn

## Summary

Updated RELOAD_READINESS_PREFLIGHT_EXAMPLE so follow-up commands are explicitly run separately and --allow-warn is documented as collection-only, not a reload pass. Governance remains clean.
...
```text
pytest governance check: 4 passed; ana_governance_check.py: PASS 116/116; allow-warn wording confirmed across reload readiness example, live behavior example, and operator runbook
```
