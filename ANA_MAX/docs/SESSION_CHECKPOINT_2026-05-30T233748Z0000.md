# Session Checkpoint - 2026-05-30T23:37:48+00:00

## Permission manifest reload example

## Summary

Added PERMISSION_MANIFEST_RELOAD_EXAMPLE documenting that ANA reloads permission policy when the manifest file changes, supporting mode/profile changes without code edits. Verified: manifest reload focused test PASS 1/1, governance PASS 91/91, governance pytest PASS 4/4, no-reload quality gate PASS 6/6.
