# Session Checkpoint - 2026-05-30T23:48:37+00:00

## MCP tools call failure normalization example

## Summary

Added MCP_TOOLS_CALL_FAILURE_NORMALIZATION_EXAMPLE and tests/runtime/test_ana_mcp_call.py. The example documents a missing-tool call returning compact JSON failure and non-zero CLI exit without traceback noise. Verified: ana_mcp_call + governance tests PASS 7/7, governance PASS 95/95, Nucleus Smoke PASS 9/9, no-reload quality gate PASS 6/6.
