# Session Checkpoint - 2026-05-31T02:00:21+00:00

## VSIX version consistency guard added

## Summary

Added ana_vsix_version_check.py to detect stale active VSIX version references after package bumps. It checks README, MARKETPLACE notes, operator reload runbook, install helper example, operator status example, and CURRENT_SESSION_HANDOFF against vscode_extension/package.json. Wired it into no_reload_quality_gate.py and lab_quality_gate.py plus examples/governance docs.
