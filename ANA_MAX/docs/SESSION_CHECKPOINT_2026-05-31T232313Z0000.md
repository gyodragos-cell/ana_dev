# Session Checkpoint - 2026-05-31T23:23:13+00:00

## Live behavior example documents allow-warn

## Summary

Updated LIVE_BEHAVIOR_CHECK_EXAMPLE and ANA_EXAMPLES_INDEX to document that --allow-warn is only for diagnostic collection, not a successful reload. Governance remains clean.
...
```text
pytest governance check: 4 passed; ana_governance_check.py: PASS 116/116; allow-warn references confirmed in runbook/example/index/memory
```
