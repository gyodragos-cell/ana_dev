# Session Checkpoint - 2026-05-30T22:22:20+00:00

## ANA examples index added

## Summary

Added ANA_EXAMPLES_INDEX.md to catalog real examples, evidence paths, profiles, and share classes. The index distinguishes public-safe, sanitized, and private-lab examples and points to bug template, autonomy warning example, tool profile report, smoke/autonomy/gate reports, Linux restore flow, and mobile QA case study.

## Current Goal

Keep ANA serious-project examples organized and safe to use for lab, QA, CV, and future sanitized sharing.

## Next Steps

- Next candidate: add sanitized Code Map and Graph Map query examples, then generate a compact public-safe examples pack later if needed.
...
```text
ana_governance_check PASS 64/64; pytest governance 4 passed; no_reload_quality_gate PASS 6/6 report ANA_MAX/dev_artifacts/reports/no_reload_quality_gate_20260531_012213.json.
```

## Risks

- Examples index references private lab report paths and a local cvnou case-study path
- keep public sharing sanitized/reviewed.
