...
try:
    ...
    print(f"✅ Desktop files: {len(files.get('files', []))} items")
except Exception as e:
    print(f"❌ Error: {e}")
...
try:
    ...
    print(f"✅ User: {term.get('output', 'N/A').strip()}")
except Exception as e:
    print(f"❌ Error: {e}")
...
try:
    ...
    print(f"✅ Active window: {ui.get('title', 'N/A')}")
except Exception as e:
    print(f"❌ Error: {e}")
...
print("  👁️  Vision: desktop_capture, windows_uia_bridge, ocr_tool")
print("  🖱️  Control: desktop_control, windows_uia_bridge")
print("  📁 Files: file_operations, smart_search, grep_content")
print("  💻 System: system_control, terminal, task")
print("  🧠 Memory: ana_memory, memory_cortex")
print("  🌐 Web: browser_control, web_search, web_scraper")
print("  🔒 Security: security_audit, frida_instrument")
print("  + 40+ more tools!")
