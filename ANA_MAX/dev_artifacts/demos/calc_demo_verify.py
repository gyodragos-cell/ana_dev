...
def click_button(title):
    try:
        ...
        if c.get("success"):
            ...
            print(f"  âŒ {title}: {c.get('error')}")
            return False
    except Exception as e:
        print(f"  âŒ {title}: {e}")
        return False

print("ðŸŽ¬ ANA MAX DEMO - Calculator")
print("\n1ï¸âƒ£  Deschid Calculator...")
subprocess.Popen(["calc.exe"])
time.sleep(5)

if not check_calc():
    print("  âŒ Calculator nu s-a deschis!")
    exit(1)

print("  âœ… Calculator vizibil!")

print("\n2ï¸âƒ£  CALCUL: 5 Ã— 5 = 25")
click_button("Five")
time.sleep(0.8)
