...
print('ðŸŽ¬ LIVE DEMO - DESKTOP AUTOMATION WOW!')
print('=' * 70)
...
if r and r.get('success'):
    ...
    print(f'    âœ“ Screenshot captured: {fname}')
...
if r and r.get('success'):
    ...
    print(f'    âœ“ Found {count} processes')
    for p in procs:
...
if r and r.get('success'):
    print(f'    âœ“ Top CPU processes identified')
    data = r['data']
    if isinstance(data, str):
        try:
...
if r and r.get('success'):
    fname = r['data']['file'].split('\\')[-1]
    print(f'    âœ“ Screenshot: {fname}')

proc.terminate()

print('\n' + '=' * 70)
print('âœ¨ DEMO COMPLETE! All 23 tools working perfectly!')
print('=' * 70)
