...
if r and r.get('success'):
    print(f'    âœ“ Screenshot: {r["data"]["file"]}')
    print('    âœ“ Vad iconita Kiro pe ecran!')
...
r = tool('desktop_capture', 'capture')
if r and r.get('success'):
    print(f'    âœ“ Screenshot final: {r["data"]["file"]}')
    print('    âœ“ Iconita Kiro e acum mai la dreapta!')

proc.terminate()

print('\n' + '=' * 70)
print('âœ¨ GATA! Iconita Kiro mutata la dreapta!')
print('=' * 70)
